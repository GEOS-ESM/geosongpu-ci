...
import geosongpu_ci.tools.plots.geos.plot_via_plotly as ph
import xarray as xr
...
candidate = xr.open_mfdataset(
    "/home/fgdeconi/work/git/geosongpu-ci/tmp/23.AU.DGPU.DEBUG/dacegpu/state_0009_tile0.nc"
)
reference = xr.open_mfdataset(
    "/home/fgdeconi/work/git/geosongpu-ci/tmp/23.AU.DGPU.DEBUG/fortran/state_0009_tile0.nc"
)
